...
const printSingleMessage = (messagesObj, container) => {
  ...
  messageElem.innerHTML = ` <div class="message">
                                ...
                                `;
  //utilizziamo append perché ogni volta non andiamo a ristampare la chat
...
export { renderChat, printMessages, printSingleMessage };
